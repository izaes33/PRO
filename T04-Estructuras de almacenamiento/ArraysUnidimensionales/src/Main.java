...
public class Main {
    public static void main(String[] args) {
        ...
        /*CrearMostrar crearMostrar = new CrearMostrar();
        crearMostrar.crearMostrar();

        RecorrerConFor recorrerConFor = new RecorrerConFor();
        recorrerConFor.recorrerConFor();

        RellenarConInput rellenarConInput = new RellenarConInput();
        rellenarConInput.rellenarConInput();

        BuscarElemento buscarElemento = new BuscarElemento();
        buscarElemento.buscarElemento();

        ContarCondicion contarCondicion = new ContarCondicion();
